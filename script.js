...
//##            var otherpeople = {'pres0704':['Dillon','1'],'pres0714':['Patrick','11'],'pres0718':['Angela','111']};
            if (typeof toolbaractive === 'undefined' || toolbaractive == 0){
                ...
                for (i=0;i<tablebodyarray.length;i++){
                    eachelement.push(document.getElementById('toolbaroption_'+i))
                    }

                eachelement.forEach(function(butto,index){
                    butto.addEventListener('click', function() {
                        document.getElementById('ctl00_GeneralContentPlaceHolder_Login1_UserName').value = Object.keys(otherpeople)[index];
                        document.getElementById('ctl00_GeneralContentPlaceHolder_Login1_Password').value = otherpeople[Object.keys(otherpeople)[index]][1];
                        document.getElementById('ctl00_GeneralContentPlaceHolder_Login1_LoginButton').click();
                })})
